...
public class JudgeMultiAnswerAction extends ActionSupport {
	...
	public String execute() {
		...
		return executer.executeJudge(submitAnswer, JudgeResult.caught_multi_choice_exercises,
				ExerciseType.MULTI_CHOICE_QUESTION) ? SUCCESS : ERROR;
	}
